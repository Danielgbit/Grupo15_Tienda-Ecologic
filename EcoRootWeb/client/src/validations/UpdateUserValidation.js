...
const UpdateUserValidation = () => {
    ...
    useEffect(() => {
        ...
        const button = document.querySelector('.button-updateUser-Validations');
        ...
        button.addEventListener('click', (e) => {
            ...
            // Condiciones para borrar contenido de mensajes de error
            if (errorFirstName && errorFirstName.textContent) {
                errorFirstName.textContent = '';
            }

            if (errorLastName && errorLastName.textContent) {
                errorLastName.textContent = '';
            }
            ...
            if (errorCountry && errorCountry.textContent) {
                errorCountry.textContent = '';
            }

            if (errorCity && errorCity.textContent) {
                errorCity.textContent = '';
            }

            if (errorAddress && errorAddress.textContent) {
                errorAddress.textContent = '';
            }

            if (errorBirthDate && errorBirthDate.textContent) {
                errorBirthDate.textContent = '';
            }

            if (errorGender && errorGender.textContent) {
