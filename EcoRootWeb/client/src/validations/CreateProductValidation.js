const CreateProductValidation = () => {
    ...
    window.addEventListener('load', () => {
        ...
        const button = document.querySelector('.submit-create-form-container');
        ...
        united && united.addEventListener('input', (e) => {
        ...
        discount && discount.addEventListener('input', (e) => {
        ...
        material && material.addEventListener('input', (e) => {
        ...
        image && image.addEventListener('input', (e) => {
        ...
        descripcion && descripcion.addEventListener('input', (e) => {
        ...
        price && price.addEventListener('input', (e) => {
        ...
        const validateImage = (image) => {
            if (image.files.length > 0) {
                ...
                if (file) {
                    if ((file.type === "image/jpeg" || file.type === "image/png") || (file.type === "image/gif" || file.type === "image/jpg")) {
                        console.log('El archivo de imagen es válido');
                    } else {
                        if (!errors.image) {
                            errors.image = [];
                        }
            ...
            // Verifica si errorImage es null antes de intentar agregar elementos hijo
            if (errorImage) {
                ...
                console.error('errorImage es null. Asegúrate de que el elemento exista en el DOM.');
            }
        };
